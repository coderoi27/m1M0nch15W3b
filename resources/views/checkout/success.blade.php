                                    ...
                                    <div class="py-5 linus-coming-soon d-flex justify-content-center align-items-center">
                                        <div class="col-md-6">
                                            <div class="text-center pb-3">
                                                ...
                                                <p>Check your order status in <a href="{{ route('my_order') }}?activeTab=progress" class="font-weight-bold text-decoration-none text-primary">My
...
@if ($message = Session::get('success'))
    ...
    <script type="text/javascript">
        ...
        <?php $cart['cart_order']['order_json']['bestCashback'] = json_decode($cart['cart_order']['order_json']['bestCashback'], true); ?>
